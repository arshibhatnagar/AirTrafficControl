...
def hello_world():
    # print "Hello"
    new_flight = FlightWaypoints(id="AA1234", 
...
def incoming_flight_data():
    ...
    # print "Flight key is: "
    flight = Flight(id=flight_num, flight_num=flight_num, location=ndb.GeoPt(latitude, longitude), 
    ...
    flight_k = update_or_insert(flight_key, flight)
    flight_key_urlsafe = flight_k.urlsafe()
